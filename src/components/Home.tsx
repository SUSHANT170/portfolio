        ...
        <div className="flex justify-center space-x-4">
          <button
            ...
            onMouseOver={(e) => {
              ...
              target.style.color = ''; 
              target.className =
                'bg-secondary text-white px-8 py-4 rounded-lg font-bold text-lg transition-colors';
            }}
            onMouseOut={(e) => {
              const target = e.target as HTMLAnchorElement;
              target.style.backgroundColor = '#F3F4F6'; 
              target.style.color = '#374151'; 
              target.className = 'px-8 py-4 rounded-lg font-bold text-lg transition-colors';
            }}
          >
            Let's Connect 🚀
          </button>
